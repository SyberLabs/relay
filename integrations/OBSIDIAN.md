...
Open Relay's **Connect Obsidian, Grok Bot, Notion & Claude** panel. If the opportunity is already in Relay, select it, choose the note purpose, then **Create note for selected job**. This fills in the job name, posting URL and a unique note ID. Move the downloaded file into your vault and edit it there.
