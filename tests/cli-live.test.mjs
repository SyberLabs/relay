...
const EXIT = { ok: 0, usage: 1, auth: 2, refused: 3, empty: 5 };
...
/* -- log: employer numbers no longer trip the gate ------------------------ */
writeFileSync(
  'private-data/cli-good.txt',
  'I read your 2024 post on storage engines. I led a team of 6 engineers.',
);
...
r = relay('outcome', job.id, 'submitted', '--receipt', 'ref');
assert.equal(
  r.code,
  EXIT.refused,
