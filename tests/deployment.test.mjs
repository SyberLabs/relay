...
test('production configuration cannot expose static assets before identity verification', () => {
...
test('configuration refuses absent credentials, placeholder database, invalid names, and non-origin URLs', () => {
...
test('artifact verification binds release SHA and every byte, rejecting missing and extra files', () => {
