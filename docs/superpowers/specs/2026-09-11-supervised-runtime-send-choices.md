...
| **T6** | Stop using heuristic fact-overlap as pick/gate copy. Fold `/plan`, `/preferences`, and `/review` under Advanced; keep the APIs; bookmarks redirect.                                            | [#197](https://github.com/SyberLabs/relay/issues/197) / [#200](https://github.com/SyberLabs/relay/pull/200)    | **Issued.** PR vs `main` after T5. T6 is not “we apply to Greenhouse.” Peer merge pending.                                                                                                                                                                           |

**Immediate next:** peer-merge T6. Do not self-approve. Do not enable `live`. Do not Worker-POST ATS. Do not promote production. Finishing T6 does not close #168’s product-market-fit question ([#5](https://github.com/SyberLabs/relay/issues/5)) and does not ship a named ATS adapter.
