...
| **T6** | Stop using heuristic fact-overlap as pick/gate copy. Fold `/plan`, `/preferences`, and `/review` under Advanced; keep the APIs; bookmarks redirect.                                            | [#197](https://github.com/SyberLabs/relay/issues/197)                                                          | **Issued.** Implementation on `cursor/t6-overlap-routes-9e98`, stacked on T5. T6 is not “we apply to Greenhouse.” Peer merge pending.                                                                                                                                                                                                 |
...
| T6: Runtime + Tracker are the real product, then delete `/plan` `/preferences` `/review` as primary routes | Seth                                                                                                    | **Yes** (this _is_ T6); #197                         | No                                                               |
